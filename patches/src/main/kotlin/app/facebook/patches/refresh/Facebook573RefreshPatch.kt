 ...
 * untouched.
 */
package app.facebook.patches.refresh
...
val blockFacebookAutomaticRefresh573Patch = bytecodePatch(
    ...
    execute {
        ...
        mainFeedHeadLoad.method.addInstructionsWithLabels(
            0,
            """
                move-object v1, p1
                ...
                return v0
            """.trimIndent(),
            ExternalLabel("froggo_refresh573_keep_head_load", mainFeedHeadLoad.method.getInstruction(0)),
        )
        ...
        mainFeedNetworkResponse.method.addInstructionsWithLabels(
            0,
            """
                ...
                return-void
            """.trimIndent(),
            ExternalLabel("froggo_refresh573_keep_network_response", mainFeedNetworkResponse.method.getInstruction(0)),
        )
