package app.facebook.patches.ads
...
val blockFacebookReelsAds573Patch = bytecodePatch(
    ...
    execute {
        reelsSwipeItemBuilder.method.addInstructionsWithLabels(
            0,
            """
                ...
                return-void
            """.trimIndent(),
            ExternalLabel("froggo_reelsads573_keep_item", reelsSwipeItemBuilder.method.getInstruction(0)),
        )
