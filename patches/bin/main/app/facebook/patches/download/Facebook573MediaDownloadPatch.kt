package app.facebook.patches.download
...
val downloadFacebookMedia573Patch = bytecodePatch(
    ...
    execute {
        ...
        storyHeaderCallback.method.addInstructionsWithLabels(
            0,
            """
                ...
                return-object v0
            """.trimIndent(),
            ExternalLabel("froggo_story_header_stock_callback", storyHeaderCallback.method.getInstruction(0)),
        )
        ...
        menuCallback.method.addInstructionsWithLabels(
            0,
            """
                ...
                return-void
            """.trimIndent(),
            ExternalLabel("froggo_story_download_stock_callback", menuCallback.method.getInstruction(0)),
        )
